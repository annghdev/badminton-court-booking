...
BEGIN
    ...
    -- Chuyển đổi @BeginAt và @EndAt sang UTC+7 để kiểm tra
    ...
    SET @FirstMatchingDate = CAST(@BeginAtLocal AS DATE);
    ...
    IF EXISTS (
        ...
        WHERE CourtId = @CourtId
          ...
          AND (
              (@BookingType = 1 AND BookingType = 1 
                AND CAST(BeginAt AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time' AS DATE) = CAST(@BeginAtLocal AS DATE))
              OR (@BookingType = 2 AND (
                  (BookingType = 1 AND CAST(BeginAt AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time' AS DATE) 
                    BETWEEN CAST(@BeginAtLocal AS DATE) AND CAST(@EndAtLocal AS DATE)
                    AND DATENAME(WEEKDAY, BeginAt AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time') = @EffectiveDayOfWeek)
                  OR (BookingType = 2 AND DayOfWeek = @EffectiveDayOfWeek 
                      AND CAST(BeginAt AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time' AS DATE) <= CAST(@EndAtLocal AS DATE)
                      AND (EndAt IS NULL OR CAST(EndAt AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time' AS DATE) >= CAST(@BeginAtLocal AS DATE)))
              ))
              OR (@BookingType = 3 AND (
                  (BookingType = 1 AND CAST(BeginAt AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time' AS DATE) >= @FirstMatchingDate
                      AND DATENAME(WEEKDAY, BeginAt AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time') = @EffectiveDayOfWeek)
                  OR (BookingType IN (2, 3) AND DayOfWeek = @EffectiveDayOfWeek 
                      AND CAST(BeginAt AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time' AS DATE) <= @FirstMatchingDate
                      AND (EndAt IS NULL OR CAST(EndAt AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time' AS DATE) >= @FirstMatchingDate))
              ))
          )
    )
    BEGIN
    ...
    IF EXISTS (
        ...
        WHERE bd.CourtId = @CourtId
          ...
          AND (
              (@BookingType = 1 AND (
                  (b.Type = 1 AND CAST(bd.BeginAt AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time' AS DATE) = CAST(@BeginAtLocal AS DATE))
                  OR (b.Type = 2 AND CAST(bd.BeginAt AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time' AS DATE) <= CAST(@BeginAtLocal AS DATE)
                             AND CAST(bd.EndAt AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time' AS DATE) >= CAST(@BeginAtLocal AS DATE)
                             AND bd.DayOfWeek = @EffectiveDayOfWeek)
                  OR (b.Type = 3 AND CAST(bd.BeginAt AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time' AS DATE) <= CAST(@BeginAtLocal AS DATE)
                             AND bd.DayOfWeek = @EffectiveDayOfWeek)
              ))
              OR (@BookingType = 2 AND (
                  (b.Type = 1 AND CAST(bd.BeginAt AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time' AS DATE) 
                    BETWEEN CAST(@BeginAtLocal AS DATE) AND CAST(@EndAtLocal AS DATE)
                    AND DATENAME(WEEKDAY, bd.BeginAt AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time') = @EffectiveDayOfWeek)
                  OR (b.Type = 2 AND CAST(bd.EndAt AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time' AS DATE) >= CAST(@BeginAtLocal AS DATE)
                             AND CAST(bd.BeginAt AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time' AS DATE) <= CAST(@EndAtLocal AS DATE)
                             AND bd.DayOfWeek = @EffectiveDayOfWeek)
                  OR (b.Type = 3 AND CAST(bd.BeginAt AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time' AS DATE) <= CAST(@EndAtLocal AS DATE)
                             AND bd.DayOfWeek = @EffectiveDayOfWeek)
              ))
              OR (@BookingType = 3 AND (
                  (b.Type = 1 AND CAST(bd.BeginAt AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time' AS DATE) >= @FirstMatchingDate
                          AND DATENAME(WEEKDAY, bd.BeginAt AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time') = @EffectiveDayOfWeek)
                  OR (b.Type = 2 AND CAST(bd.EndAt AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time' AS DATE) >= @FirstMatchingDate
                             AND CAST(bd.BeginAt AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time' AS DATE) <= @FirstMatchingDate
                             AND bd.DayOfWeek = @EffectiveDayOfWeek)
                  OR (b.Type = 3 AND CAST(bd.BeginAt AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time' AS DATE) <= @FirstMatchingDate
                             AND bd.DayOfWeek = @EffectiveDayOfWeek)
              ))
          )
    )
